      ...
      <div className="mx-auto max-w-6xl px-6 pt-16 pb-8">
        ...
        <div className="grid gap-12 md:grid-cols-2">
          <div>
            ...
            <img src="/wordmark.png" alt="Washermann" className="mb-6 h-6 w-auto" />
        ...
        <div className="mt-6 flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-5 text-white">
            ...
            <a href={SITE.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="transition-colors hover:text-wm-mint">
            ...
            <a href={SITE.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="transition-colors hover:text-wm-mint">
